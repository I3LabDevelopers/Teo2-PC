        ...
        private void ParseXB(string command)
        {
            ...
            if (!motion_block)
            {
                switch (command)
                {
                    case "A":
                        SetMood("scared");
                        Program.sound_player.SoundLocation = "voice/Spaventato.WAV";
                        Program.sound_player.PlaySync();
                        break;

                    case "B":
                        SetMood("angry");
                        Program.sound_player.SoundLocation = "voice/Arrabbiato.WAV";
                        Program.sound_player.PlaySync();
                        break;

                    case "X":
                        SetMood("sad");
                        Program.sound_player.SoundLocation = "voice/Triste.WAV";
                        Program.sound_player.PlaySync();
                        break;

                    case "Y":
                        SetMood("happy");
                        Program.sound_player.SoundLocation = "voice/Felice.WAV";
                        Program.sound_player.PlaySync();
                        break;
            ...
            if (parsing_map.ContainsKey(command))
            {
                command = parsing_map[command];
                switch (command)
                {
                    case "ciao":
                        break;
